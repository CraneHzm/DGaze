...
def main(args):
    ...
    # regress 2 values
    n_output = 2
    model = DGaze_SGazeDataset(input_size, args.seqLength, args.seqFeatureNum, args.saliencyWidth, args.saliencyNum, n_output, args.dropout_rate)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--datasetDir', default = '../../DGazeDataset/dataset/SGaze/', type = str, 
                        help = 'the directory that saves the dataset (default: ../../DGazeDataset/dataset/SGaze/)')
    ...
    parser.add_argument('-c', '--checkpoint', default = '../checkpoint/SGaze/', type = str, 
                        help = 'path to save checkpoint (default: ../checkpoint/SGaze/)')
    # path to save the summary
    parser.add_argument('-s', '--summaryDir', default = '../summary/SGaze/', type = str, 
                        help = 'path to save the summary (default: ../summary/SGaze/)')
    ...
    parser.add_argument('-p', '--predictionDir', default = '../predictions/SGaze/', type = str, 
                        help = 'the directory that saves the prediction results (default: ../predictions/SGaze/)')
